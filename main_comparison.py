    ...
    for index, row in tcr_df.iterrows():
        ...
        if args.similarity_metric == "TCRdist":
            ...
            if all_present:
                ...
                pdb_id_similar = find_closest_tcr(tcr_dist_df, alpha_seq, beta_seq, epitope_seq, seq_dict, tcr_id) # Parsed df excluding alleles not present in the db of the method
            else:
