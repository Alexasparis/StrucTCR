...
# EXAMPLE: python main.py -t input/control_fold_1/1bd2_df.csv -e LLFGYPVYV -a "A*02:01" -tp ./model/TCR-p_all/ -mp ./model/TCR_MHC_all.csv -s ./output/scores.csv -w 5
...
def process_tcr(tcr_id, alpha_seq, beta_seq, epitope_seq, tcr_p_potential, tcr_mhc_potential, mhc_df, chain_dict, similarity_df, verbose, mhc_allele=None):
    ...
    if pdb_id_similar:
        ...
        if mhc_allele:
            ...
            total_score_mhc = contacts_imgt_M['potential'].sum()
