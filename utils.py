...
# Finctions shared by the different scripts:
...
def extract_specific_sequences(pdb_file, chain_types_dict, extract_sequences_fn):
    """
    ...
    chain_seq_dict = extract_sequences_fn(pdb_file)
    
    # Check if the pdb_id is in the chain_types_dict
