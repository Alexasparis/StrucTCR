...
# Example of usage
# python3 main_fast.py -p ./pdb_files/ -t ./benchmark1/5d2l_df.csv -e NLVPMVATV -m ./input/input_MHCs.csv -pp ./model/TCRen_TCR_p_training.csv -mhcp ./model/TCRen_TCR_MHC_training.csv -g ./structures_annotation/general.txt -metric TCRdist -s scores_5d2l.csv
