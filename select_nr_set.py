...
# 1) parse_general_file (general.txt)
# 2) extract_specific_sequences (pdb_file, chain_dict)
# 3) calculate_sequence_distance (seq1, seq2)
# 4) calculate_damerau_distance (seq1, seq2)
...
from utils import extract_specific_sequences, parse_general_file, extract_sequences
...
def get_non_redundant_structures(df_clusters):
    ...
    """
    # Sort PDB IDs alphabetically within each cluster
