...
def process_file(input_file):
    ...
    output_file = f'./training_set_similar/scores_seq_20_30_{tcr_id}.csv'  # Output file
    ...
    if reference_allele and isinstance(reference_allele, str):
        command = [
            ...
            '-p', './pdb_files/',
            '-t', f'./input/input_training_similar/20<d<30/{input_file}',  # Use the current input file
...
def main():
    ...
    input_files = [f for f in os.listdir('./input/input_training_similar/20<d<30') if f.endswith('.csv')]
