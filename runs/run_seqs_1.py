...
def process_file(input_file):
    ...
    output_file = f'./scores_random_{tcr_id}.csv'  # Output file
    ...
    if reference_allele and isinstance(reference_allele, str):
        command = [
            ...
            '-p', './pdb_files/',
            '-t', f'./input/input_test_seq/groups/{input_file}',  # Use the current input file
...
def main():
    ...
    input_files = [f for f in os.listdir('./input/input_test_seq/groups') if f.endswith('.csv')]
